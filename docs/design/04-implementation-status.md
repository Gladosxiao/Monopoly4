...
> 当前版本已实现完整的可玩闭环：掷骰、移动、买地、升级、改建、过路费扩展、30 张卡片/13 种道具、事件/新闻/股票/公司/保险系统、移动阶段、陷阱触发、NPC、医院格特效、土地权限到期、贷款/还款、多地图加载、乐透/魔法屋、神明完整效果（财神/穷神租金、福神买地打折/送卡、衰神买地/商店破坏、天使/恶魔住院入狱天数、土地公守护建筑）、土地公/天使 100% 挡灾、破产前 3 次法拍、3 个小游戏接入、胜利条件完整检查以及保险骗保联动。后端测试 345+ 用例，金融/事件/商店/神明/小游戏/破产法拍等模块覆盖率显著提升。剩余可细化项主要包括 12 名角色的属性差异、地图限定事件、更复杂的前端动画与特效。
...
| 4 | 土地类型 | 80% | 大小块/建筑类型/特殊建筑租金均已落地，新增 `miniGame` 格；研究院产物未实现 |
| 5 | 土地购买与升级 | 90% | 购买/升级/改建可用，福神/衰神已影响买地/升级费用；大块土地默认建住宅，建造费用简化 |
| 6 | 过路费 | 95% | 住宅/连锁店/特殊建筑/神明/卡片影响均已实现，福神经过对手土地可随机获卡 |
