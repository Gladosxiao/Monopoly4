...
> 当前版本已实现最基础的可玩闭环（掷骰、移动、买地、升级、住宅过路费、破产判定），并补全了过路费扩展、30 张卡片/13 种道具、事件/新闻/股票/公司/保险系统，以及移动阶段、陷阱触发、NPC（四大恶人/恶犬/乞丐）与医院格特效。剩余主要缺口为土地权限到期、贷款、多地图加载、乐透/魔法屋、神明变身规则与胜利条件完整检查。
...
| 神明变身/消失 | 7 天后变身或消失 | 到期消失已实现；7 天后变身为高一/低一级神明的规则占位 | ⚠️ 部分实现 |
