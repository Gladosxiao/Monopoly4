...
| 过路费倍率 `rentMultiplier` | 1.0 | 1.0 | 全局租金缩放 |
| 地产价格倍率 `propertyPriceMultiplier` | 1.0 | 0.5 | 买地/升级价格缩放 |
...
| 指标 | 健康范围 | 当前观测 |
|---|---|---|
| 平均回合数 | 40～120 | 启发式 4 人局约 61 回合 |
| 破产率 | 每局至少 1～2 人破产 | 启发式局 3/4 破产 |
| 地产购买率 | 80% 以上空地被购买 | LLM 局约 95% |
| 股票参与度 | 至少 50% 玩家交易 | 待补充 |
| 卡片使用次数 | 人均 3～5 次 | 待补充 |
| 最大单次租金/总资产 | <30% | 待补充 |
