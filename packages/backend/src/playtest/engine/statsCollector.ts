...
<div class="flex">
  ...
  <div class="kpi"><div class="num">${stockTradeCount}</div><div class="label">股票交易</div></div>
...
${stockTradeCount < 3 ? '<div class="warn">⚠ 注意：股票交易次数过少（<' + stockTradeCount + '），建议增加股票策略引导。</div>' : ''}
