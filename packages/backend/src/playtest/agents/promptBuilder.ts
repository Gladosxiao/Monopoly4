...
### 决策优先级（从高到低，不可违反）
1. **如果 availableActions 中有 buyProperty：必须选择 buyProperty**，除非你买完地后现金会低于总资产的 10%。买地就是扩大资产差距的最直接手段。
2. **如果 availableActions 中有 upgradeProperty 且你现金≥升级费用+总资产20%：选择 upgradeProperty**，高级地产带来高额租金，能快速榨干对手现金。
...
### 资产配置纪律
- 理想比例：地产 50%-70%，现金 20%-30%，股票 10%-20%。地产是拉开差距的基石。
